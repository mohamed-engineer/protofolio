...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-blue-950/20 to-slate-950 text-white overflow-x-hidden relative" suppressHydrationWarning>
      <style>{`
        @keyframes float {
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <ul className="hidden md:flex gap-8">
            {['Home', 'About', 'Skills', 'Organizations', 'Contact'].map((item, i) => (
              <li key={item} className="animate-slide-down" style={{ animationDelay: `${i * 0.1}s` }}>
      ...
      <section id="home" className="max-w-6xl mx-auto px-6 py-20 text-center relative z-10">
        ...
        <p className="text-xl md:text-2xl text-slate-300 mb-2 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          Full-Stack MERN Developer & Entrepreneur
        </p>
        <p className="text-lg text-slate-400 mb-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
          18 years old | Founder of Provix Tech | Software Manager at SRVS
        </p>
        
        {/* Social Media Icons */}
        <div className="flex justify-center gap-6 mb-8">
          <a href="https://www.linkedin.com/in/mohamed-hoosam11/" className="w-12 h-12 rounded-full bg-slate-700 hover:bg-blue-500 flex items-center justify-center transition transform hover:scale-110" title="LinkedIn">
          ...
          <a href="https://www.x.com/cjq8_" className="w-12 h-12 rounded-full bg-slate-700 hover:bg-blue-400 flex items-center justify-center transition transform hover:scale-110" title="Twitter/X">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
            </svg>
          </a>
          <a href="https://github.com/mohamed-engineer" className="w-12 h-12 rounded-full bg-slate-700 hover:bg-purple-500 flex items-center justify-center transition transform hover:scale-110" title="GitHub">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.instagram.com/cjq8_" className="w-12 h-12 rounded-full bg-slate-700 hover:bg-pink-500 flex items-center justify-center transition transform hover:scale-110" title="Instagram">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="mailto:mohamedhossam4work@gmail.com" className="w-12 h-12 rounded-full bg-slate-700 hover:bg-red-500 flex items-center justify-center transition transform hover:scale-110" title="Email">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex justify-center gap-4">
          <a href="#organizations" className="px-8 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition">
            View My Work
          </a>
          <a href="mailto:your-email@example.com" className="px-8 py-3 border border-blue-400 rounded-lg font-semibold hover:bg-blue-400/10 transition">
            Get In Touch
          </a>
        </div>
      </section>
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-20 border-t border-slate-700/50 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-3 gap-6 animate-slide-right">
      ...
      <section id="skills" className="max-w-6xl mx-auto px-6 py-20 border-t border-slate-700/50 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Frontend */}
          <div className="bg-slate-800/30 rounded-lg p-8 border border-blue-400/30 hover:border-blue-400/60 transition card-hover backdrop-blur-sm animate-fade-in-scale">
            ...
            <div className="flex flex-wrap gap-3">
              {['HTML', 'CSS', 'JavaScript', 'React.js', 'Next.js', 'Tailwind CSS', 'SASS', 'Bootstrap', 'jQuery'].map((skill, i) => (
                <span key={skill} className="px-4 py-2 bg-blue-500/20 text-blue-300 rounded-full text-sm border border-blue-400/30 hover:bg-blue-500/40 transition skill-badge animate-slide-up" style={{ animationDelay: `${0.2 + i * 0.05}s` }}>
                  {skill}
                </span>
              ))}
            </div>
          ...
          {/* Backend */}
          <div className="bg-slate-800/30 rounded-lg p-8 border border-cyan-400/30 hover:border-cyan-400/60 transition card-hover backdrop-blur-sm animate-fade-in-scale" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="flex flex-wrap gap-3">
              {['Node.js', 'Express.js', 'MongoDB', 'RESTful APIs', 'Authentication', 'Database Design'].map((skill, i) => (
                <span key={skill} className="px-4 py-2 bg-cyan-500/20 text-cyan-300 rounded-full text-sm border border-cyan-400/30 hover:bg-cyan-500/40 transition skill-badge animate-slide-up" style={{ animationDelay: `${0.2 + i * 0.05}s` }}>
                  {skill}
                </span>
              ))}
            </div>
          ...
          {/* Design & Other */}
          <div className="bg-slate-800/30 rounded-lg p-8 border border-purple-400/30 hover:border-purple-400/60 transition card-hover backdrop-blur-sm animate-fade-in-scale" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-wrap gap-3">
              {['Graphic Design', 'UI/UX Design', 'Responsive Design', 'Performance Optimization', 'SEO', 'Problem Solving'].map((skill, i) => (
                <span key={skill} className="px-4 py-2 bg-purple-500/20 text-purple-300 rounded-full text-sm border border-purple-400/30 hover:bg-purple-500/40 transition skill-badge animate-slide-up" style={{ animationDelay: `${0.2 + i * 0.05}s` }}>
                  {skill}
                </span>
              ))}
            </div>
      ...
      <section id="organizations" className="max-w-6xl mx-auto px-6 py-20 border-t border-slate-700/50 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Provix Tech */}
          <div className="bg-gradient-to-br from-blue-500/10 to-slate-800/30 rounded-lg p-10 border border-blue-400/30 hover:border-blue-400/60 transition org-card card-hover backdrop-blur-sm animate-slide-left relative overflow-hidden">
          ...
          {/* SRVS */}
          <div className="bg-gradient-to-br from-cyan-500/10 to-slate-800/30 rounded-lg p-10 border border-cyan-400/30 hover:border-cyan-400/60 transition org-card card-hover backdrop-blur-sm animate-slide-right relative overflow-hidden">
            <div className="absolute inset-0 rounded-lg opacity-0 hover:opacity-100 transition duration-300" style={{
          ...
          {/* EYE Youth Entity */}
          <div className="bg-gradient-to-br from-purple-500/10 to-slate-800/30 rounded-lg p-10 border border-purple-400/30 hover:border-purple-400/60 transition org-card card-hover backdrop-blur-sm animate-fade-in-scale" style={{ animationDelay: '0.2s' }}>
            <div className="absolute inset-0 rounded-lg opacity-0 hover:opacity-100 transition duration-300" style={{
        ...
        <div className="max-w-2xl mx-auto bg-slate-800/30 rounded-lg p-8 border border-blue-400/30 backdrop-blur-sm animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <form action="https://formspree.io/f/xzzlgeqk" method="POST" className="space-y-6">
            ...
            <div className="flex gap-4 animate-slide-up" style={{ animationDelay: '0.5s' }}>
              <button
                type="submit"
                className="flex-1 px-8 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition duration-300 transform hover:scale-105"
              >
                Send Message
              </button>
